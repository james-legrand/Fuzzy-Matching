...
class MatchingTool:
    ...
    def __init__(self):     
        ...
        self.advanced_switch.place(x=10, y=30, anchor="nw")
    ...
    def toggle_multi_match(self):
        ...
        self.debug_message(f"Matching on single variable: {new_state}")
    ...
    def setup_tasks(self, dataset_1_rows):
        ...
        -------
            ...
            Threshold to update the progress bar (every 10% of the total)
    ...
    def run_matching(self):
        ...
        def run_in_thread():
            ...
            if multi_match_flag:
                ...
                column_list = [dataset_1_id_col, dataset_2_id_col, dataset_1_match_col_1, dataset_1_match_col_2, 'Score 1', dataset_2_match_col_1, dataset_2_match_col_2, 'Score 2', 'Match Score']
                ...
                column_list = [dataset_1_id_col, dataset_2_id_col, dataset_1_match_col_1, dataset_2_match_col_1, 'Match Score']
